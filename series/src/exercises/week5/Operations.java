...
class Operations {
    ...
    static void operation2(int[] tableau) {
        ...
        System.out.println("Il y a "+ nb +" elements >4 || <2 dans le tableau");
    }
    ...
    static void operation3(int[] tableau) {
        ...
        System.out.println("La somme de tous les élements du tableau est égale à "+ sum);
    }
    ...
    static void operation4(int[] tableau) {
        ...
        System.out.println("La moyenne arithmétique des élements du tableau est égale à : "+ mv/ tableau.length);
    }
