...
abstract class Courrier {
    ...
    // si le mode déxpédition est  express (éviter la duplication du code
...
class Colis extends Courrier {
    ...
    // ici il faut redéfinir  (spécialiser) la re`gle de validité des colis
